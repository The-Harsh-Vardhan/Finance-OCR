...
class FarmKnowledgeBase:
    ...
    TERM_MAPPINGS = {
        ...
        "electron": ("Pesticide", "Insecticide (Electron)", "en"),
        "paraquat": ("Pesticide", "Herbicide (Paraquat)", "en"),
        "parquat": ("Pesticide", "Herbicide (Paraquat)", "en"),
        "apsa": ("Pesticide", "Adjuvant (Apsa 80)", "en"),
        "straygain": ("Pesticide", "Plant Growth Regulator", "en"),
        "stroygain": ("Pesticide", "Plant Growth Regulator", "en"),
